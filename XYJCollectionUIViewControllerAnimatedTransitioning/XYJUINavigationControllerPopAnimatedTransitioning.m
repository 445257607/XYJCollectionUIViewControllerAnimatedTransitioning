//
//  XYJUINavigationControllerPopAnimatedTransitioning.m
...
@interface XYJUINavigationControllerPopAnimatedTransitioning()
...
@implementation XYJUINavigationControllerPopAnimatedTransitioning
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    CGRect fromViewEndFrame = CGRectMake(containerBounds.size.width, 0, containerBounds.size.width, containerBounds.size.height);
    CGRect toViewBeginFrame = CGRectMake(-containerBounds.size.width * 0.3, 0, containerBounds.size.width, containerBounds.size.height);
    ...
    [transitionContext.containerView insertSubview:_parallaxDimmingView belowSubview:fromView];
    ...
    [UIView animateWithDuration:[self transitionDuration:transitionContext] * 0.5 delay:0 usingSpringWithDamping:1 initialSpringVelocity:0 options:0 animations:^{
        ...
        wself.parallaxDimmingView.alpha = 0;
